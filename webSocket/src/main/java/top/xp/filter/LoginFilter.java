package top.xp.filter;

import top.xp.common.Constants;
...
public class LoginFilter implements Filter {
    ...
    private boolean notFilter(String uri) {
        return uri.equals("/") || uri.contains("/user/login") || uri.contains("/code") || uri.contains("/static/")|| uri.contains("/webSocket");
    }
}
