...
public class ObjectFactory {
    ...
    private final static QName _SayHello_QNAME = new QName("http://service.xp.top/", "sayHello");
    private final static QName _SayResponse_QNAME = new QName("http://service.xp.top/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://service.xp.top/", "say");
    private final static QName _SayHelloResponse_QNAME = new QName("http://service.xp.top/", "sayHelloResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xp.top/", name = "sayHello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xp.top/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xp.top/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xp.top/", name = "sayHelloResponse")
